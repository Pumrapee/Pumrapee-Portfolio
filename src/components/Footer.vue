...
<template>
  <footer
    class="w-full border-t border-cyan-400/20 bg-slate-900/80 py-5 text-center text-slate-300"
  >
    <p class="text-cyan-300 mb-2">Contact</p>
    <div class="mt-2 flex flex-wrap gap-4 justify-center text-sm">
      <a
        href="https://github.com/pumrapee"
        target="_blank"
      ...
      >
        ...
        <span class="text-cyan-300">GitHub</span>
      </a>
